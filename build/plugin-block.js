...
function Edit(_a) {
  ...
  var _g = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(attributes.vscoin || 'usd'),
    vscoin = _g[0],
    setVscoin = _g[1];
  var _h = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(attributes.period || 'daily'),
    period = _h[0],
    setPeriod = _h[1];
  var _j = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(attributes.steps || 30),
    steps = _j[0],
    setSteps = _j[1];
  var _k = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(attributes.dateFrom || last30DaysDateTime),
    dateFrom = _k[0],
    setDateFrom = _k[1];
  var _l = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(attributes.dateTo || currentDateTime),
    dateTo = _l[0],
    setDateTo = _l[1];
  var _m = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(attributes.showTitle || false),
    showTitle = _m[0],
    setShowTitle = _m[1];
  var _o = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(JSON.parse(attributes.dates) || []),
    labels = _o[0],
    setLabels = _o[1];
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", __assign({}, (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.useBlockProps)(), {
    children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", __assign({
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("h5", __assign({
        ...
        children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.SelectControl, {
          className: "",
        ...
        }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.SelectControl, {
          className: "",
          ...
          children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.TextControl, {
            ...
            children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.DatePicker, {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ CoinSettings)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react/jsx-runtime */ "./node_modules/react/jsx-runtime.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @wordpress/components */ "@wordpress/components");
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _utils_cryptocoins_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/cryptocoins.json */ "./src/utils/cryptocoins.json");
var __assign = undefined && undefined.__assign || function () {
  __assign = Object.assign || function (t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
      s = arguments[i];
 ...
 * Code
 */
function CoinSettings(_a) {
  var id = _a.id,
    coinElement = _a.coinElement,
    labelsElement = _a.labelsElement,
    vscoin = _a.vscoin,
    period = _a.period,
    steps = _a.steps,
    dateFrom = _a.dateFrom,
    dateTo = _a.dateTo,
    updateCoin = _a.updateCoin,
    removeCoin = _a.removeCoin;
  ...
  var _c = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false),
    isSaving = _c[0],
    setIsSaving = _c[1];
  var _d = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(coinElement === null || coinElement === void 0 ? void 0 : coinElement.coin),
    coin = _d[0],
    setCoin = _d[1];
  var _e = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)((coinElement === null || coinElement === void 0 ? void 0 : coinElement.prices) || []),
    prices = _e[0],
    setPrices = _e[1];
  var _f = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(labelsElement !== null && labelsElement !== void 0 ? labelsElement : []),
    labels = _f[0],
    setLabels = _f[1];
  var _g = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)((coinElement === null || coinElement === void 0 ? void 0 : coinElement.color) || '#497bb1'),
    color = _g[0],
    setColor = _g[1];
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
    ...
    if (!coin || coin == '') return;
    setIsSaving(true);
    (0,_utils_utils__WEBPACK_IMPORTED_MODULE_3__.getMarketChart)(coin, vscoin, steps, period, dateFrom, dateTo).then(function (response) {
      var newlabels = [];
      var newprices = [];
      for (var _i = 0, _a = response.prices; _i < _a.length; _i++) {
        var currency = _a[_i];
        newlabels.push(dayjs__WEBPACK_IMPORTED_MODULE_2___default()(currency[0]).format('DD/MM/YYYY'));
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", __assign({
    ...
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.SelectControl, {
      ...
      options: _utils_cryptocoins_json__WEBPACK_IMPORTED_MODULE_5__,
      onChange: function (newVal) {
        return setCoin(newVal);
      },
      __nextHasNoMarginBottom: true
    }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", __assign({
...
function getMarketChart(coin, vscoin, days, interval, dateFrom, dateTo) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          dateFromTime = Math.floor(new Date(dateFrom).getTime() / 1000);
          dateToTime = Math.floor(new Date(dateTo).getTime() / 1000);
          url = new URL("https://api.coingecko.com/api/v3/coins/".concat(coin, "/market_chart/range?vs_currency=").concat(vscoin, "&from=").concat(dateFromTime, "&to=").concat(dateToTime));
        ...
        case 2:
          ...
          dailyLabels = [];
          dailyPrices = [];
          for (_i = 0, _a = data.prices; _i < _a.length; _i++) {
            item = _a[_i];
            dateFromTime_1 = new Date(parseInt(item[0]));
            date = dateFromTime_1.getFullYear() + '-' + dateFromTime_1.getMonth() + '-' + dateFromTime_1.getDate();
            if (!lastDate) {
              lastDate = date;
            }
...
"use strict";
module.exports = JSON.parse('[{"label":"Select Crypto","value":"","symbol":""},{"label":"Bitcoin","value":"bitcoin","symbol":"BTC"},{"label":"Ethereum","value":"ethereum","symbol":"ETH"},{"label":"BNB","value":"bnb","symbol":"BNB"},{"label":"XRP","value":"ripple","symbol":"XRP"},{"label":"Cardano","value":"cardano","symbol":"ADA"},{"label":"Doge Coin","value":"dogecoin","symbol":"DOGE"},{"label":"Polkadot","value":"polkadot","symbol":"DOT"},{"label":"Chainlink","value":"chainlink","symbol":"LINK"},{"label":"Shiba Inu","value":"shiba-inu","symbol":"SHIB"},{"label":"Decentraland","value":"decentraland","symbol":"MANA"}]');

/***/ }),

/***/ "./src/utils/fiatcoins.json":
/*!**********************************!*\
  !*** ./src/utils/fiatcoins.json ***!
  \**********************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('[{"label":"US Dollar","value":"usd","symbol":"USD"},{"label":"Euro","value":"eur","symbol":"EUR"}]');
...
"use strict";
/*!******************************!*\
  !*** ./src/plugin-block.tsx ***!
  \******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/blocks */ "@wordpress/blocks");
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _block_Edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block/Edit */ "./src/block/Edit.tsx");
/* harmony import */ var _block_Save__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./block/Save */ "./src/block/Save.tsx");
/* harmony import */ var _plugin_block_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./plugin-block.scss */ "./src/plugin-block.scss");
/**
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)('crypto-chart-block/editor', {
  ...
  edit: _block_Edit__WEBPACK_IMPORTED_MODULE_1__["default"],
  save: _block_Save__WEBPACK_IMPORTED_MODULE_2__["default"]
});
})();
